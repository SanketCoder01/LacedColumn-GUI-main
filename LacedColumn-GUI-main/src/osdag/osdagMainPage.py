...
#################################### Module Launchers ##########################################
    ...
    def show_compression_module(self):
        ...
        if self.findChild(QRadioButton, 'Strut_Design').isChecked():
        ...
        elif self.findChild(QRadioButton, 'Laced_Column_Design').isChecked():
            # Hide the main window properly and ensure it's not visible
            self.hide()
            ...
            self.ui2.setWindowModality(Qt.NonModal)
            
            # Connect the closed signal to show the main window again
            self.ui2.closed.connect(self.show_main_window)
...
################################# Help Actions ############################################
    ...
    def show_main_window(self):
        """Show the main window when module window is closed"""
